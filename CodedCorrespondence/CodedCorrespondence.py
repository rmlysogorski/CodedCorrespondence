...
def decode_message(message, offset):
    decoded_message = ""
    for i in message:
        if i == " " or i == "'" or i == "!" or i == "?" or i == "." or i == "," or i == ":" or i == ";": decoded_message += i
        elif (letters.find(i) + offset > 25):
            decoded_message += letters[(letters.find(i) + offset) % 26]
        else: 
            decoded_message += letters[letters.find(i)+offset]
    return decoded_message

message = "xuo jxuhu! jxyi yi qd unqcfbu ev q squiqh syfxuh. muhu oek qrbu je tusetu yj? y xefu ie! iudt cu q cuiiqwu rqsa myjx jxu iqcu evviuj!"
print(decode_message(message, 10))
...
def code_message(message, offset):
    coded_message = ""
    for i in message.lower():
        if i == " " or i == "!" or i == "?" or i == "." or i == "'" or i == "," or i == ":" or i == ";": coded_message += i
        else: 
            coded_message += letters[letters.find(i) - offset]
    return coded_message

my_message = "This is pretty fun! I really like this. We should do it more often. It's neat."
print(code_message(my_message, 10))
print(decode_message("jxyi yi fhujjo vkd! y huqbbo byau jxyi. mu ixekbt te yj cehu evjud. yj'i duqj.", 10))
...
print(decode_message("vhfinmxkl atox kxgwxkxw tee hy maxlx hew vbiaxkl tl hulhexmx. px'ee atox mh kxteer lmxi ni hnk ztfx by px ptgm mh dxxi hnk fxlltzxl ltyx.", 7))
...
def V_decoder(message, keyword):
    ...
    for i in message:
        if i == " " or i == "'" or i == "!" or i == "?" or i == "." or i == "," or i == ":" or i == ";": decoded_message += i
            ...
            offset = letters.find(keyword[count % len(keyword)])
            decoded_message += letters[(letters.find(i) - offset) % 26]
        count += 1
    return decoded_message

print(V_decoder("dfc jhjj ifyh yf hrfgiv xulk? vmph bfzo! qtl eeh gvkszlfl yyvww kpi hpuvzx dl tzcgrywrxll!", "friends"))
...
def V_coder(message, keyword):
    ...
    for i in message:
        if i == " " or i == "'" or i == "!" or i == "?" or i == "." or i == "," or i == ":" or i == ";": coded_message += i
            ...
            offset = letters.find(keyword[count % len(keyword)])
            coded_message += letters[(letters.find(i) + offset) % 26]
        count += 1
    return coded_message

my_message = "this assignment was freakin cool!"
my_keyword = "sweet"
print(V_coder(my_message, my_keyword))
print(V_decoder("ldmw sowmzfiirm sew xniedaj ghgh!", my_keyword))
